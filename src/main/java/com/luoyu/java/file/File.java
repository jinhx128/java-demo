...
public class File {
     ...
     */
    public static void test1(String file, String conent) throws Exception {
     ...
     * 追加文件：使用FileWriter
     */
    public static void test2(String fileName, String content) throws Exception {
     ...
     */
    public static void test3(String fileName, String content) throws Exception {
        // 打开一个随机访问文件流，按读写方式
     ...
     * 追加文件：使用FileWriter
     */
    public static void test4(String path, String content) throws Exception {
